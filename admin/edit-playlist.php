...
$query=mysqli_query($con,"Update  tblplaylist set PlaylistName='$playlist',Description='$description' where id='$catid'");
if($query)
{
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Playlist </b></h4>
                                    <hr />
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,PlaylistName,Description,PostingDate from  tblplaylist where Is_Active=1 and id='$catid'");
$cnt=1;
                        				...
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="playlist" method="post">
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="<?php echo htmlentities($row['PlaylistName']);?>" name="playlist" required>
	                                                </div>
	                                            </div>
