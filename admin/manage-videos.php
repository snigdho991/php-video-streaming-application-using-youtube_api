...
<table  class="table table-colored table-centered table-inverse m-0" id="videoTable">
<thead>
<tr>
...
<td><a href="edit-video.php?pid=<?php echo $result['videoid']; ?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
    &nbsp;<a href="manage-videos.php?pid=<?php echo $result['videoid']; ?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
 </tr>
 <?php } } ?>
