...
<?php
    if(!isset($_GET['ctid']) || $_GET['ctid'] == NULL){
        ...
        $id = preg_replace('/[^-a-zA-z0-9_]/', '', $_GET['ctid']);
    }
?>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="breadcrumbs">
                    <h2 class="page-title"><?php echo $result['CategoryName']; ?></h2>
                    <ul style="text-transform: none;">
                        <li>
                            <a class="active" href="index.php">Home</a>
                        </li>
                        <li><a class="active" href="news.php?ctid=<?php echo $result['id']; ?>">News</a></li>
...
<section class="blog-details-area ptb-90">
    <div class="container">
        <div class="row">
            ...
            <?php
                $getnw = $nw->getNewsByCt($id, $start_from, $total_pages);
                if(!$getnw){ 
            ?>
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                     <blockquote style="border-left: 2px solid #065fd4;width: 400px;"><p style="color: #065fd4;"><b>No news found in this category !
                        </b></p>
                    </blockquote>
...
<!--- Pagination --->
<?php 
    $query  = "SELECT * FROM tblposts WHERE CategoryId = '$id'";
...
?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="another-pages text-center">
                            <ul>
                            <li><a href="news.php?ctid=<?php echo $id; ?>&&page=1"><i class="icofont icofont-double-left"></i></a></li>
    ...
    if(isset($_GET['page']) && $_GET['page'] == $i){
     ...
     href="news.php?ctid=<?php echo $id; ?>&&page=<?php echo $i; ?>"><?php echo $i; ?> </a>
<?php
} ?></li>

                            <li><a href="news.php?ctid=<?php echo $id; ?>&&page=<?php echo $total_records; ?>"><i class="icofont icofont-double-right"></i></a></li>
                        </ul>
                        </div>
                    </div>
                </div>
            ...
            ?> 
                        <ul>
                            <li><a <?php if ($result['id'] == $id) {echo 'class="activate"';}
                                ?> href="news.php?ctid=<?php echo $result['id']; ?>"><?php echo $result['CategoryName']; ?></a> </li>                
                        </ul>
            <?php } } ?>
                    </div>
